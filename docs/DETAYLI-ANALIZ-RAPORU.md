...
| P2-6 | [Dockerfile:22-30](Dockerfile:22) | backend image'de frontend build — ama dist nginx'te; backend dist'i ölü. `npm install` yerine `npm ci` | ✅ backend build kaldırıldı, `npm ci` |
